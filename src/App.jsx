  ...
  return (
    <div className="fade-up">
      ...
      <Card style={{ marginBottom: 12 }}>
        ...
        <p style={{ fontSize: 13, color: C.muted, marginBottom: 8 }}>All predictions for a given day's matches lock at <strong style={{ color: C.white }}>3pm Irish time</strong>. Make sure you're in before then!</p>
        <p style={{ fontSize: 13, color: C.muted }}>You can predict ahead for future matches — just tap "Next 3 matches".</p>
      </Card>
      <Card style={{ marginBottom: 12 }}>
